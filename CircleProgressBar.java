package com.example.zjyang.view;
...
import com.example.zjyang.eplace.R;
...
public class CircleProgressBar extends View{
    ...
    public void init(Context context, AttributeSet attributeSet){
        ...
        roundWidth = typedArray.getDimension(R.styleable.CircleProgressBar_roundWidth, 60);
        bgStrokeWidth = typedArray.getDimension(R.styleable.CircleProgressBar_bgStrokeWidth, 10);
        roundColor  = typedArray.getColor(R.styleable.CircleProgressBar_roundColor, Color.LTGRAY);
        progressStrokeWidth = typedArray.getDimension(R.styleable.CircleProgressBar_progressStrokeWidth, 20);
        progressColor  = typedArray.getColor(R.styleable.CircleProgressBar_progressColor, getResources().getColor(R.color.app_main_color));
        textColor = typedArray.getColor(R.styleable.CircleProgressBar_textColor, Color.BLACK);
        textSize = typedArray.getDimension(R.styleable.CircleProgressBar_textSize, 40);
